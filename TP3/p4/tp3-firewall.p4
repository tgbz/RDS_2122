...
parser MyParser(packet_in packet,
                out headers hdr,
                inout metadata meta, //inout - structures capable of passing information between blocks, defined above; user-defined
                inout standard_metadata_t standard_metadata) { //v1model defined
    /**
...
control MyIngress(inout headers hdr,
    ...
    Finding the next hop IP address. */
